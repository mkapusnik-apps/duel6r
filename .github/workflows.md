...
- **Artifacts and diagnostics:** Validation diagnostics, smoke evidence, and master transport artifacts are retained for seven days; nightly transport remains at one day. Failed graphical-test diagnostics preserve CTest logs and original evidence while excluding derived crop and normalized PNGs.
