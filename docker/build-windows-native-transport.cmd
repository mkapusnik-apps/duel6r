...
cmake --build C:\workspace\build-windows-native-transport --config Release --target duel6r-session-transport-tests duel6r-network-trust-policy-tests duel6r-admission-compatibility-tests duel6r-server
if errorlevel 1 exit /b %errorlevel%
