...
| `NET-04` | Target lobby and readiness | [Specification](network-lobby.md) | [Wireframe](wireframes/network-lobby.md) | `NET-AC-004`–`NET-AC-008`, `NET-AC-014`, `NET-AC-016`–`NET-AC-018`; issue #32 `AHM-AC-003`–`AHM-AC-007`, `AHM-AC-019`, `AHM-AC-025`–`AHM-AC-026`, `AHM-AC-032` | Targets: `docs/network-play-first-release.md`; `docs/network-authoritative-headless-match.md` |
...
| `NET-06` | Target final session summary | [Specification](network-summary.md) | [Wireframe](wireframes/network-summary.md) | `NET-AC-010`, `NET-AC-011`, `NET-AC-014`, `NET-AC-016`–`NET-AC-018`; issue #32 `AHM-AC-016`, `AHM-AC-020`–`AHM-AC-024`, `AHM-AC-029`, `AHM-AC-032` | Targets: `docs/network-play-first-release.md`; `docs/network-authoritative-headless-match.md` |
