...
- No silence, refusal, unreachable, reset, timeout, host crash, host-machine/listener loss, temporary failure, or isolation-only state may use `NET-09` or claim that the host ended the session.
