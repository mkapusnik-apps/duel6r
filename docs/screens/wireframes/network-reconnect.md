...
- Resolution, refusal, unreachable, reset, timeout, host crash, host-machine/listener loss, temporary failure, and no response remain retryable in this state against the original deadline.
