...
Fresh `SS-010` and `SS-011` artifacts now include complete provenance below and are `Pending` UX assessment.
...
- Assessment status: `Pending` UX assessment; this provenance record does not claim conformance.
